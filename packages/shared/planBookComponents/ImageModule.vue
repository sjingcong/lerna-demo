<template>
  <div class="image-module">
    <!-- 如果有图片列表，显示图片网格 -->
    <div v-if="props.data?.images && props.data.images.length > 0" class="images-grid">
      <div 
    ...
    <div v-else class="default-content">
      <div class="content-section">
        <h2 v-if="props.data?.title" class="module-title">{{ props.data.title }}</h2>
        <p v-if="props.data?.description" class="module-description">{{ props.data.description }}</p>
